...
- Usage: Reference from command with `@/Users/danielshalem/triolla/telent-os-backend/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/danielshalem/triolla/telent-os-backend/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/danielshalem/triolla/telent-os-backend/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
