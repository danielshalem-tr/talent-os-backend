...
- **Global scope**: `/Users/danielshalem/triolla/telent-os-backend/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/danielshalem/triolla/telent-os-backend/.claude/notes/`)
...
2. Glob `/Users/danielshalem/triolla/telent-os-backend/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/danielshalem/triolla/telent-os-backend/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/danielshalem/triolla/telent-os-backend/.claude/notes/` — works in any directory
